...
module.exports = {
    ...
    SESSION: (process.env.SESSION || process.env.Raganork~318838160ceb228cd05f1d6f16940424:445a594766653951302b6f3d || '').trim() || '',
    ...
    BOT_NAME: process.env.BOT_NAME || 'Alisha Fatima',
